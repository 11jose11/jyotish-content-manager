...
export const nameMappings: Record<string, string> = {
  ...
  // Special Yogas - Auspicious
  'Amrita Siddhi': 'Amrita Siddhi',
  'Sarvartha Siddhi': 'Sarvartha Siddhi',
  'Guru Pushya': 'Guru Pushya',
  'Tripushkara': 'Tripushkara',
  'Suta': 'Suta',
  'Siddha Special': 'Siddha',
  'Ravi Pushya': 'Ravi Pushya',
  'Dvipushkara': 'Dvipushkara',
  'Dwipushkara': 'Dwipushkara',
  'Siddhi Special': 'Siddhi',
  'Amritasiddha': 'Amritasiddha',
  'Jaya Special': 'Jaya',
  'Guru Yoga': 'Guru Yoga',
  'Shukra Yoga': 'Shukra Yoga',
  'Mangala Yoga': 'Mangala Yoga',
  'Siddha Vara Nakshatra A': 'Siddha Vara Nakshatra A',
  'Shobhana Special': 'Shobhana',
  'Siddha Vara Tithi Grupos': 'Siddha Vara Tithi Grupos',
  'Amrita Vara Tithi Grupos': 'Amrita Vara Tithi Grupos',
  'Ravi Yoga': 'Ravi Yoga',
  'Subha Special': 'Subha',
  'Subha Madhyama': 'Subha Madhyama',
  'Aadala': 'Aadala',
  
  // Special Yogas - Inauspicious
  'Dagdha Special': 'Dagdha',
  'Visha Special': 'Visha',
  'Utpata': 'Utpata',
  'Mrityu Special': 'Mrityu',
  'Dagdha Vara Tithi': 'Dagdha Vara Tithi',
  'Hutashana Vara Tithi': 'Hutashana Vara Tithi',
  'Visha Vara Tithi': 'Visha Vara Tithi',
  'Samvartaka': 'Samvartaka',
  'Krakacha': 'Krakacha',
  'Yamaghanta': 'Yamaghanta',
  'Mrityu Vara Nakshatra': 'Mrityu Vara Nakshatra',
  'Hutasana': 'Hutasana',
  'Panchaka': 'Panchaka',
  'Rikta Special': 'Rikta',
  'Kana Special': 'Kana',
  'Dagdha Vara Nakshatra': 'Dagdha Vara Nakshatra',
  'Utpata Vara Nakshatra': 'Utpata Vara Nakshatra',
  'Kana Vara Nakshatra': 'Kana Vara Nakshatra',
  'Nasa Vara Nakshatra': 'Nasa Vara Nakshatra',
  'Asubha Tithi Nakshatra': 'Asubha Tithi Nakshatra'
}
